...
path_to_geometry = os.path.join(
    os.path.expanduser("~"),
    'Seafile/Meine Bibliothek/e_geopandas/dhs_geometry/Export/')

path_to_data = os.path.join(
    os.path.expanduser("~"),
    'Seafile/Meine Bibliothek/c_oemof_work/80_data/dhs_test_data/')

df_houses = Dbf5(os.path.join(path_to_geometry,
                              'Points_all.dbf')).to_dataframe()
